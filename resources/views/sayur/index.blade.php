...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <h1 class="mb-4"> List Data Sayur</h1>
        ...
        <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <span>{{ $row->nama }}</span>
                <div>
                  <a href="{{ route('sayur.show', $row->id) }}" class="btn btn-success">
                  <i class="fa-regular fa-eye"></i>
                  </a>
                  <a href="{{ route('sayur.edit', $row->id) }}" class="btn btn-primary">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{{ route('sayur.destroy', $row->id) }}" class="btn btn-danger">
          Delete
        </a>
      </div>
    </div>
        ...
        <a href="{{ route('sayur.tambah') }}" class="btn btn-warning mb-4">Tambah Data</a>
    </div>
